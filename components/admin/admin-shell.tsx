...
// Screen titles
const screenTitles: Record<AdminScreenKey, string> = {
...
export function AdminShell() {
  const [screen, setScreen] = useState<AdminScreenKey>("admin-login")
  ...
  const showHeaderAndNav = !["admin-login", "role-hub"].includes(screen)
